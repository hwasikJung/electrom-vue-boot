    ...
    callback({
      responseHeaders: {
        ...
        "Content-Security-Policy": [
          process.env.NODE_ENV === "development" ? `default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; connect-src 'self' http://localhost:* http://127.0.0.1:*; img-src 'self' data:; font-src 'self' data:` : `default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; connect-src 'self' ${process.env.SPRING_API_URL || "http://localhost:4141/api/v1"}; img-src 'self' data:; font-src 'self' data:`
        ]
      }
    });
  });
